...
# Можна використовувати одну назву зміних в різних
# функція так як в функції локальна область видимості.
# d = 32
# def foo(d):
#     d = d + 32
#     print(d)
...
# в функції ми не обьявляємо список, сет,
# дікт бо це зміний тип даних і для різних викликів буде
# одне і те ж айді.
...
print(sorted(list_1, key=lambda x: x%2))# сортує по тим шо діляться на 2
# (ті що не діляться виводить в кінці
print(sorted(list_3, key=len))# сортує по довжині слова
print(sorted(list_2, key=lambda a: a[-1]))# сортує по останній букві
#


# todo Питають на співбесіді: Що таке args і kwargs -> *args - аргументи ,
