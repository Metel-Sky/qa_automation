...
#
# word = input("Введіть число: ")
# rewers= ''.join(reversed(word))
# print(rewers)
#
#=======================================================================================================================
#
...
#
# Задача №4
# Ваша програма повинна вміти розділяти один список на два та помістити їх у новий список. Тобто,
# в результаті повинен вийти список із 2-х списків.
...
# Задача №5
# Робимо хештег
# Користувач вводить рядок, ви з цього рядка видаляєте все окрім цифр і букв,
# додаєте на початок хештег і всі слова пишите з великої літери
#
# Приклади
...
#
# Задача №5 Поліндром
# Запитайте в користувача слово і перевірте чи воно являється поліндромом(читається однаково зліва на право і з право на ліво)
# Памятайте що користувач може ввести слово з великої літери і може додати пробіли.
#
#
#
#
...
#
# Задача №10
# Попросіть користувача ввести рядок зі словами,
# підрахуйте кількість цих слів і виведіть користувачу, скільки слів він ввів.
#
# Задача №11 напишіть програму яка буде разувати кількість слів в тексті.
